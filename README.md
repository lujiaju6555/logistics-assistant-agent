...
这是一个基于大语言模型的京东物流智能客服系统，采用模块化、流水线式架构，实现了完整的客服对话流程。系统支持多轮对话、信息抽取、业务工具调用和知识库检索，能够为用户提供准确、及时的物流相关服务。
核心亮点：
 - 混合检索：集成 Qwen-Embedding + BM25 对原问题和重写问题进行多路召回，结合BGE-M3进行重排序，Recall@5 达到 93%
